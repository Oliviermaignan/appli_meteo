...
//     hour: 'numeric',
//     minute: 'numeric',
//     hour12: unitSystem !== "metric"
//   });
// };

//! ici je peux retourner l'heure sous différents format en fonction de l'unité de mesure choisie
export const getTime = (unitSystem, currentTime, timezone) => {
    return unitSystem === 'metric'
        ...
        : //format retourne directement AM ou PM
...
//simplification de la fonction en enlevant la timezone
...
export const getWeekDay = (weatherData) => {
    ...
    return weekday[new Date(weatherData.daily.time[0]).getUTCDay()]
}
